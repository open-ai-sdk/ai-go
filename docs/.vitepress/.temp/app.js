...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"ai-go","description":"A provider-neutral Go SDK for building AI applications.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/logo-light.svg","dark":"/logo-dark.svg","alt":"ai-go"},"nav":[{"text":"Get Started","link":"/getting-started"},{"text":"Docs","link":"/docs/"},{"text":"Tutorials & Guides","link":"/guides/"},{"text":"Examples","link":"/examples/"},{"text":"API Reference","link":"https://pkg.go.dev/github.com/open-ai-sdk/ai-go"}],"sidebar":{"/guides/":[{"text":"Tutorials & Guides","items":[{"text":"Overview","link":"/guides/"},{"text":"Build a chat server","link":"/guides/chat-server"},{"text":"Error handling","link":"/guides/error-handling"}]}],"/examples/":[{"text":"Examples","items":[{"text":"Overview","link":"/examples/"}]}],"/reference/":[{"text":"Reference","items":[{"text":"Overview","link":"/reference/"},{"text":"Package map","link":"/reference/package-map"}]}],"/":[{"text":"Documentation","items":[{"text":"Overview","link":"/docs/"},{"text":"Quickstart","link":"/getting-started"},{"text":"Why ai-go","link":"/docs/why-ai-go"},{"text":"Architecture","link":"/docs/architecture"}]},{"text":"Concepts","collapsed":false,"items":[{"text":"Overview","link":"/core/"},{"text":"Providers and clients","link":"/core/providers-and-clients"},{"text":"Completions","link":"/core/completions"},{"text":"Messages and content","link":"/core/messages-and-content"},{"text":"Agents","link":"/core/agents"},{"text":"Agent Runner","link":"/core/agent-runner"},{"text":"Hooks","link":"/core/hooks"},{"text":"Tools","link":"/core/tools"},{"text":"Streaming","link":"/core/streaming"},{"text":"Structured output","link":"/core/structured-output"},{"text":"Embeddings","link":"/core/embeddings"},{"text":"Media generation","link":"/core/media-generation"},{"text":"Observability","link":"/core/observability"}]},{"text":"Integrations","collapsed":false,"items":[{"text":"Overview","link":"/integrations/"},{"text":"Model providers","collapsed":false,"items":[{"text":"Overview","link":"/providers/"},{"text":"OpenAI","link":"/providers/openai"},{"text":"Other providers","link":"/providers/other-providers"}]},{"text":"Model Context Protocol","link":"/integrations/mcp"},{"text":"AI SDK v7 UI streams","link":"/integrations/ui-streams"}]},{"text":"Extensions","items":[{"text":"Extend ai-go","link":"/docs/extensions"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/open-ai-sdk/ai-go"}],"editLink":{"pattern":"https://github.com/open-ai-sdk/ai-go/edit/main/docs/:path","text":"Edit this page on GitHub"},"footer":{"message":"Released under the MIT License.","copyright":"Copyright © open-ai-sdk contributors"},"search":{"provider":"local"},"outline":{"level":[2,3],"label":"On this page"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.Bm2kIFsp.js"));
