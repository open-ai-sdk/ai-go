...
func TestGolden_DeepThinking_WithSourcesAndCustomData(t *testing.T) {
	...
	engineCh := makeEvents(
		...
		StepEvent{Type: StepEventReasoningDelta, ReasoningDelta: "I need to find recent AI trends..."},
		StepEvent{Type: StepEventReasoningDelta, ReasoningDelta: " Let me search the web."},
		StepEvent{
		...
		StepEvent{Type: StepEventTextDelta, TextDelta: "AI in 2025 saw major releases "},
		StepEvent{Type: StepEventTextDelta, TextDelta: "from Google and OpenAI."},
...
func TestGolden_DefaultChat(t *testing.T) {
	...
	text := a.Stream(makeEvents(
		...
		StepEvent{Type: StepEventTextDelta, TextDelta: "How can I help you today?"},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	), &buf)
