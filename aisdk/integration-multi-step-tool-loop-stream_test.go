...
func toolResultEvent(id, name, args, output string, pm map[string]any) StepEvent {
	return StepEvent{
...
func TestIntegration_MultiStepToolLoop_ChunkSequence(t *testing.T) {
	sr := newMockStreamEventer(
		...
		StepEvent{Type: StepEventToolCallStart, ToolCallID: "tc-1", ToolCallName: "search"},
		...
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventTextDelta, TextDelta: "The answer is 42."},
...
func TestIntegration_MultiStepToolLoop_PersistedParts(t *testing.T) {
	sr := newMockStreamEventer(
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventToolCallStart, ToolCallID: "tc-2", ToolCallName: "lookup"},
		toolResultEvent("tc-2", "lookup", `{"key":"x"}`, `"found"`, nil),
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonToolCalls},

		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventTextDelta, TextDelta: "Done."},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	)
