...
func newMockStreamEventer(evs ...StepEvent) *mockStreamEventer {
...
func (m *mockStreamEventer) Stream() <-chan StepEvent { return m.ch }
...
func TestToUIMessageStream_SendSourcesTrue(t *testing.T) {
	sr := newMockStreamEventer(
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventSource, Source: &Source{
			ID: "src-1", URL: "https://example.com", Title: "Example",
		}},
		StepEvent{Type: StepEventTextDelta, TextDelta: "text"},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	)
...
func TestToUIMessageStream_MessageMetadata(t *testing.T) {
	sr := newMockStreamEventer(
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventTextDelta, TextDelta: "hi"},
		StepEvent{Type: StepEventUsage, Usage: &Usage{
			InputTokens:        10,
			OutputTokens:       5,
			TotalTokens:        15,
			OutputTokenDetails: OutputTokenDetails{ReasoningTokens: 3},
		}},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	)
...
func TestToUIMessageStream_ChannelCloses(t *testing.T) {
	sr := newMockStreamEventer(
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventTextDelta, TextDelta: "x"},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	)
...
func TestToUIMessageStream_NilMetadataCallback(t *testing.T) {
	sr := newMockStreamEventer(
		StepEvent{Type: StepEventStepStart},
		StepEvent{Type: StepEventTextDelta, TextDelta: "plain"},
		StepEvent{Type: StepEventStepEnd, FinishReason: FinishReasonStop},
		StepEvent{Type: StepEventDone},
	)
