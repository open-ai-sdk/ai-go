...
// StreamEventer is the producer side of a step-event stream. It stays an interface
// so a caller can supply any source — the Eino adapter, a fake, or a replay — without
// this package naming it.
type StreamEventer interface {
	Stream() <-chan StepEvent
