...
// ChunkProducer translates StepEvents into a channel of typed Chunks.
...
func (cp *ChunkProducer) Produce(ch <-chan StepEvent) *ChunkStream {
...
func (cp *ChunkProducer) translateEvent(ev StepEvent) ([]Chunk, string) {
	switch ev.Type {
...
func (cp *ChunkProducer) chunksTextDelta(ev StepEvent) ([]Chunk, string) {
	var out []Chunk
...
func (cp *ChunkProducer) chunksReasoningDelta(ev StepEvent) []Chunk {
	var out []Chunk
...
func (cp *ChunkProducer) chunksToolCallStart(ev StepEvent) []Chunk {
	tcID := ev.ToolCallID
	if tcID == "" {
		return nil
	}
...
func (cp *ChunkProducer) chunksToolCallDelta(ev StepEvent) []Chunk {
	tcID := ev.ToolCallID
...
func (cp *ChunkProducer) chunksToolCallReady(ev StepEvent) []Chunk {
	tcID := ev.ToolCallID
...
func (cp *ChunkProducer) chunksToolResult(ev StepEvent) []Chunk {
...
func (cp *ChunkProducer) chunksToolCallInvalid(ev StepEvent) []Chunk {
...
func (cp *ChunkProducer) chunksSource(ev StepEvent) []Chunk {
