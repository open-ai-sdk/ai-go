...
// tools use [NewDynamic]. A [Set] is immutable and snapshots definitions with
// their exact invokers. [ResultInvokable] and [ExecutionResult] add ordered
...
// remain in the normal Go error chain. Handler contexts retain cancellation,
// deadlines, configured tool/run values, and the tool-call ID.
package tool
