...
func TestValidateToolsContextRequiredField(t *testing.T) {
	req := GenerateTextRequest{Tools: &ToolSet{Definitions: []ToolDefinition{{Name: "lookup", ContextSchema: map[string]any{"required": []any{"tenant"}}}}}, ToolsContext: ToolsContext{"lookup": map[string]any{}}}
